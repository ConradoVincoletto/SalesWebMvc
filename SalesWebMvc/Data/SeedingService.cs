...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", 1000.00, new DateTime(1998, 04, 21), d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", 3500.00, new DateTime(1979, 12, 31), d2);            
            Seller s3 = new Seller(3, "Martha Red", "martha@gmail.com", 3000.00, new DateTime(1988, 1, 15), d1);
            Seller s4 = new Seller(4, "Donald Blue", "donald@gmail.com", 4000.00, new DateTime(2000, 1, 9), d4);
            Seller s5 = new Seller(5, "Alex Pink", "Alex@gmail.com", 3000.00, new DateTime(1997, 3, 4), d2);
            Seller s6 = new Seller(6, "Alex Grey", "alexg@gmail.com", 2500.00, new DateTime(1983, 05, 27), d3);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 9, 25), 11000.00, SalesStatus.Billed, s1);
